        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-40">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 animate-fade-up delay-200">
                    <Link
                        href="/prompter"
                        className="group relative px-10 h-16 bg-white text-black font-normal text-lg rounded-2xl hover:scale-[1.02] transition-all active:scale-95 flex items-center justify-center shadow-[0_0_30px_rgba(255,255,255,0.2)] lowercase cursor-pointer"
                    >
                        start recording
                    ...
                    <Link
                        href="#features"
                        className="px-10 h-16 bg-transparent text-white font-normal text-lg rounded-2xl border-2 border-white hover:bg-white hover:text-black transition-all active:scale-95 flex items-center justify-center lowercase cursor-pointer"
                    >
                        view features
                    </Link>
                    ...
                    <a
                        href="/extension"
                        className="group relative px-10 h-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-normal text-lg rounded-2xl hover:scale-[1.02] transition-all active:scale-95 flex items-center justify-center shadow-[0_0_30px_rgba(59,130,246,0.3)] lowercase cursor-pointer"
                    >
