        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-black/50 backdrop-blur-md border-b border-white/5">
            <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-8">
                    <a href="/#features" className="text-sm font-normal text-zinc-400 hover:text-white transition-colors lowercase cursor-pointer">features</a>
                    <a href="/#pricing" className="text-sm font-normal text-zinc-400 hover:text-white transition-colors lowercase cursor-pointer">pricing</a>
                    <a href="/#about" className="text-sm font-normal text-zinc-400 hover:text-white transition-colors lowercase cursor-pointer">about</a>
                    <a href="/extension" className="text-sm font-normal text-zinc-400 hover:text-white transition-colors lowercase flex items-center gap-1 cursor-pointer">
