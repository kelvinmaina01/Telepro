            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-12">
                    ...
                    <div className="flex items-center justify-center gap-4 mb-8">
                        <span className={`text-sm transition-colors ${!isYearly ? 'text-white' : 'text-zinc-500'}`}>monthly</span>
                        <button
                ...
                <div className="flex flex-col md:flex-row justify-center gap-8 max-w-5xl mx-auto">
                    ...
                    <div className="flex-1 p-10 rounded-[32px] border bg-zinc-900/50 border-white/5 transition-all">
                        <h3 className="text-sm tracking-[0.2em] mb-4 text-zinc-500 lowercase">starter</h3>
                        <div className="flex items-baseline gap-1 mb-6">
                            <span className="text-5xl font-normal tracking-tight text-white lowercase">free</span>
                        </div>
                        ...
                        <div className="space-y-4 mb-12">
                            {[
                                ...
                                <div key={fIndex} className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm font-normal text-zinc-400">{feature}</span>
                                </div>
                            ))}
                        </div>
                        <Link href="/prompter" className="w-full h-16 rounded-2xl flex items-center justify-center font-normal text-lg transition-all active:scale-95 bg-white text-black hover:bg-zinc-100 lowercase">
                            start for free
                        </Link>
                    </div>
                    ...
                    <div className="flex-1 p-10 rounded-[32px] border bg-white border-white transition-all shadow-xl scale-105">
                        <h3 className="text-sm tracking-[0.2em] mb-4 text-black/60 lowercase">professional</h3>
                        <div className="flex items-baseline gap-1 mb-6">
                            <span className="text-5xl font-normal tracking-tight text-black">
                                ${isYearly ? yearlyPrice : monthlyPrice}
                            </span>
                            <span className="text-lg text-black/40">/month</span>
                        </div>
                        ...
                        <div className="space-y-4 mb-12">
                            {[
                                ...
                                <div key={fIndex} className="flex items-center gap-3">
                                    ...
                                    <span className="text-sm font-normal text-black/80">{feature}</span>
                                </div>
                            ))}
                        </div>
