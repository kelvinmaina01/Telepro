        ...
        <>
            ...
            <div className="fixed bottom-0 left-0 right-0 z-30 bg-[#0f0f0f] border-t border-zinc-800">
                <div className="flex items-center justify-center gap-4 px-4 py-3 md:py-2 text-xs text-zinc-500">
                    <span className="hidden md:inline">Created by <a href="https://harda.dev" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-white transition-colors">harda.dev</a></span>
                    <span className="hidden md:inline text-zinc-700">•</span>
                    <a href="https://github.com/hardaistee" target="_blank" rel="noopener noreferrer" className="hidden md:inline-flex text-zinc-400 hover:text-white transition-colors items-center gap-1">
