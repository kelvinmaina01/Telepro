        ...
        <>
            ...
            <div className="fixed bottom-12 left-1/2 -translate-x-1/2 z-40 w-[98%] md:w-auto max-w-[1200px]">
                ...
                >
                    ...
                    <button
                        onClick={onPlayPause}
                        className={`shrink-0 flex items-center gap-2.5 px-4 h-12 rounded-2xl transition-all duration-300 group ${isPlaying
                    ...
                    <button
                        onClick={onStop}
                        className="shrink-0 flex items-center gap-2 px-4 h-12 rounded-2xl bg-white/5 hover:bg-red-500/20 text-red-500 transition-all duration-300 border border-white/5 hover:border-red-500/50 hover:scale-105 active:scale-95"
                    >
                        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                    ...
                    <button
                        ...
                        className={`shrink-0 flex items-center gap-2.5 px-4 h-12 rounded-2xl transition-all duration-300 group ${isRecordingEnabled
                    ...
                    <div className="shrink-0 flex items-center gap-2">
                        ...
                        <button
                            ...
                            className={`shrink-0 flex flex-col items-center justify-center w-14 h-14 rounded-2xl transition-all duration-300 ${isMirrored
                        ...
                        <button
                            ...
                            className={`shrink-0 flex flex-col items-center justify-center w-14 h-14 rounded-2xl transition-all duration-300 ${isReversed
                    ...
                    <div className="shrink-0 flex items-center gap-2">
                        ...
                        <button
                            ...
                            className="shrink-0 flex flex-col items-center justify-center w-14 h-14 rounded-2xl bg-white/5 text-zinc-500 border border-white/10 hover:text-white hover:bg-white/10 transition-all duration-300 hover:scale-110"
                        >
                            <svg className="w-4 h-4 mb-1" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                        ...
                        {/* Countdown */}
                        <div className="shrink-0 flex flex-col items-center justify-center w-14 h-14 rounded-2xl bg-white/5 text-zinc-500 border border-white/10 hover:bg-white/10 transition-colors relative group">
                            <input
                                type="text"
                                inputMode="numeric"
